...
export function BubbleEditorContent() {
...
// ─── floating wrapper (kept for legacy / re-open button) ─────────────────────
...
export default function FloatingBubbleEditor({ onClose }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '12px 14px', maxHeight: 'calc(100vh - 140px)', overflowY: 'auto' }}>
        <BubbleEditorContent />
      </div>
    </div>
  )
