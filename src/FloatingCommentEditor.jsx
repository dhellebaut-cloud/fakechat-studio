...
import CommentEditorPanel from './comments/CommentEditorPanel'

export default function FloatingCommentEditor({ visible, onClose }) {
  const [pos, setPos] = useState(() => ({
    x: Math.max(8, window.innerWidth / 2 - 215 - 300),
    y: 76,
  }))
  ...
  return (
    <div ref={panelRef} className="floating-panel" style={{ left: pos.x, top: pos.y }}>
      <div className="floating-panel-handle" onMouseDown={handleDragStart}>
        ...
        <span className="floating-panel-title">Comment Editor</span>
